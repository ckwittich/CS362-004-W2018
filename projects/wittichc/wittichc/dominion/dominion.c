...
int adventurerPlay(struct gameState *state, int currentPlayer)
{
  ...
  int deckTotal = state->deckCount[currentPlayer] + discardCount[currentPlayer];

	while(drawntreasure<2 && drawntreasure + z < deckTotal)
	{
...
int minePlay(struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos)
{
	int i, j;
...
int remodelPlay(struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos)
{
	int j, i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
		case adventurer:
			return adventurerPlay(state, currentPlayer);
...
*/			
		case council_room:
			return council_roomPlay(state, currentPlayer, handPos);
/*
	  		//+4 Cards
	  		for (i = 0; i < 4; i++)
			{
...
*/		
    ...
    case mine:
    	return minePlay(state, currentPlayer, choice1, choice2, handPos);
/*      	j = state->hand[currentPlayer][choice1];  //store card we will trash
...
*/			
    case remodel:
    	return remodelPlay(state, currentPlayer, choice1, choice2, handPos);
/*      	j = state->hand[currentPlayer][choice1];  //store card we will trash
...
*/		
    case smithy:
    	return smithyPlay(state, currentPlayer, handPos);
/*  		//+3 Cards
  		for (i = 0; i < 3; i++)
		{
	  		drawCard(currentPlayer, state);
